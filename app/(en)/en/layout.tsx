...
export default function EnglishLayout({ children }: LayoutProps<"/en">) {
  return <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}><body className="min-h-full flex flex-col"><GoogleAdsTag />{children}</body></html>;
}
