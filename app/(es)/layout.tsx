...
export default function SpanishLayout({ children }: LayoutProps<"/">) {
  return <html lang="es" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}><body className="min-h-full flex flex-col"><GoogleAdsTag />{children}</body></html>;
}
