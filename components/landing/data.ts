...
export const content: Record<Locale, LandingContent> = {
  es: {
    ...
    hero: { role: "Full-Stack & Applied AI Engineer", title: "Construyo productos y sistemas operativos con IA, desde la arquitectura hasta producción.", lede: "Ingeniero de software con experiencia en producto, frontend, backend e integraciones. Combino TypeScript, React, Python y FastAPI para convertir procesos complejos en herramientas que puedan operarse y mantenerse.", focusLabel: "Tecnologías y áreas principales", experience: "Ver experiencia y proyectos", nuteam: "Automatizar un proceso con NuTeam", newTab: "abre en una nueva pestaña" },
