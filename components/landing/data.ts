...
type LandingContent = {
  ...
  header: { homeLabel: string; navLabel: string; experience: string; projects: string; capabilities: string; nuteam: string; contact: string; languageLabel: string; languageName: string; languageHref: string };
  hero: { role: string; title: string; lede: string; focusLabel: string; experience: string; nuteam: string; newTab: string };
  ...
  nuteam: { eyebrow: string; title: string; description: string; boundary: string; cta: string; newTab: string };
  contact: { eyebrow: string; title: string; description: string; commercialTitle: string; commercialDescription: string; commercialCta: string; newTab: string; formTitle: string; formDescription: string };
...
export const NUTEAM_URL = "https://www.nuteam.ai/";
...
export const content: Record<Locale, LandingContent> = {
  es: {
    ...
    header: { homeLabel: "Wilmar Florez Samudio, inicio", navLabel: "Navegación principal", experience: "Experiencia", projects: "Proyectos", capabilities: "Capacidades", nuteam: "NuTeam", contact: "Contacto", languageLabel: "Cambiar el idioma a inglés", languageName: "EN", languageHref: "/en" },
    hero: { role: "Full-Stack & Applied AI Engineer", title: "Construyo productos, automatizaciones y software con IA, desde la arquitectura hasta producción", lede: "Ingeniero de software con experiencia en producto, frontend, backend e integraciones. Combino TypeScript, React, Python y FastAPI para convertir procesos complejos en herramientas que puedan operarse y mantenerse.", focusLabel: "Tecnologías y áreas principales", experience: "Ver experiencia y proyectos", nuteam: "Automatizar un proceso con NuTeam", newTab: "abre en una nueva pestaña" },
    ...
    logistics: { imageAlt: "Camión de carga en carretera", title: "Logística y operaciones", description: "La automatización comercial para operaciones logísticas se presenta ahora en NuTeam.", context: "Áreas", items: [], project: "Ver proyectos" },
    nuteam: { eyebrow: "Ruta para empresas", title: "Automatización operativa con NuTeam", description: "NuTeam es la iniciativa comercial mediante la cual evalúo y construyo automatizaciones para procesos operativos, con foco inicial en logística.", boundary: "Esta landing demuestra quién soy y qué puedo ejecutar. NuTeam explica la oferta comercial y recibe las consultas de empresas que quieren automatizar un proceso.", cta: "Conocer NuTeam", newTab: "abre en una nueva pestaña" },
    contact: { eyebrow: "Roles y colaboraciones", title: "Quiero conversar sobre un rol o colaboración", description: "Si buscas sumar un Full-Stack & Applied AI Engineer a un equipo, cubrir un contrato o explorar una colaboración profesional, escríbeme por este formulario.", commercialTitle: "¿Quieres automatizar un proceso?", commercialDescription: "La evaluación comercial y las consultas de automatización se gestionan desde NuTeam.", commercialCta: "Ir al formulario de NuTeam", newTab: "abre en una nueva pestaña", formTitle: "Cuéntame sobre el rol o colaboración.", formDescription: "Responderé al correo que registres para entender el contexto y cómo podría aportar." },
  ...
  en: {
    ...
    header: { homeLabel: "Wilmar Florez Samudio, home", navLabel: "Main navigation", experience: "Experience", projects: "Projects", capabilities: "Capabilities", nuteam: "NuTeam", contact: "Contact", languageLabel: "Switch language to Spanish", languageName: "ES", languageHref: "/" },
    hero: { role: "Full-Stack & Applied AI Engineer", title: "I build AI-powered products, automations, and software, from architecture to production", lede: "Software engineer with experience across product, frontend, backend, and integrations. I combine TypeScript, React, Python, and FastAPI to turn complex processes into tools that can be operated and maintained.", focusLabel: "Core technologies and disciplines", experience: "View experience and projects", nuteam: "Automate a process with NuTeam", newTab: "opens in a new tab" },
    ...
    logistics: { imageAlt: "Cargo truck on a road", title: "Logistics and operations", description: "Commercial automation for logistics operations is now presented through NuTeam.", context: "Areas", items: [], project: "View projects" },
    nuteam: { eyebrow: "For companies", title: "Operational automation with NuTeam", description: "NuTeam is the commercial initiative through which I assess and build automations for operational processes, with an initial focus on logistics.", boundary: "This landing shows who I am and what I can execute. NuTeam explains the commercial offer and receives inquiries from companies looking to automate a process.", cta: "Discover NuTeam", newTab: "opens in a new tab" },
    contact: { eyebrow: "Roles and collaborations", title: "I want to discuss a role or collaboration", description: "If you are looking to add a Full-Stack & Applied AI Engineer to a team, fill a contract, or explore a professional collaboration, use this form to reach me.", commercialTitle: "Want to automate a process?", commercialDescription: "Commercial assessments and automation inquiries are handled through NuTeam.", commercialCta: "Go to NuTeam's form", newTab: "opens in a new tab", formTitle: "Tell me about the role or collaboration.", formDescription: "I will reply to the email you provide to understand the context and how I could contribute." },
